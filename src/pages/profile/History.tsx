...
//   return (
//     <div className="bg-[#161619] h-screen text-white">
  ...
  useEffect(() => {
    ...
    if (watchHistory) {
      ...
      for (const key in parsedData) {
        const movieDetail = parsedData[key].movieDetail?.movieDetail;
        const lastEpisodeKey = Object.keys(parsedData[key]).find((epKey) =>
          epKey.includes("episode_")
        );

        if (movieDetail && lastEpisodeKey) {
          movieDetails.push({
            id: movieDetail.id,
            name: movieDetail.name,
            last_episodeid: lastEpisodeKey,
            progress_time: parsedData[key][lastEpisodeKey].progressTime,
